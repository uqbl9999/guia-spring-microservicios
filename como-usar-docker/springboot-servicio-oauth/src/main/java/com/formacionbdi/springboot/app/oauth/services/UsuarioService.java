...
public class UsuarioService implements UserDetailsService, IUsuarioService {
    ...
    // Con esto se inyecta el tracer de sleuth
    @Autowired
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        try {
            ...
            log.error(error);
            // Aqui se agrega el tag error.mensaje al span actual de sleuth
            // y se le asigna el valor de la variable error + ": " + e.getMessage()
